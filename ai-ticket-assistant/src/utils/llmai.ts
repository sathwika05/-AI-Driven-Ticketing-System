...
const analyzeTicket = async (ticket):Promise<TicketAnalysis | null> =>{
...
if (message) {
    if ('content' in message) {
      ...
      raw = (message as any).result;
    } else {
      console.log("Unknown message type, can't extract content");
    }
  } else {
  ...
  if (!raw) {
    console.log("No raw content to parse");
    return null;
  }
